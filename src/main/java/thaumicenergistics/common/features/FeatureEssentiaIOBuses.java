...
public class FeatureEssentiaIOBuses extends ThEThaumcraftResearchFeature {
    ...
    protected boolean checkConfigs(final IThEConfig theConfig) {
        this.isImportExportEnabled = theConfig.craftIOBuses()
                && (AEConfig.instance.isFeatureEnabled(AEFeature.ImportBus)
                        || AEConfig.instance.isFeatureEnabled(AEFeature.ExportBus));
