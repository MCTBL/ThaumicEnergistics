...
public class PartArcaneCraftingTerminal extends ThERotateablePart
    ...
    public ItemStack decrStackSize(final int slotIndex, final int amount) {
        ...
        if (this.isSlotInRange(slotIndex)) {
            ...
            if (slotStack != null) {
                ...
                // If is it the results stack, the whole stack must be returned, can not 'partially' take the crafting
                // result.
    ...
    public boolean isItemValidForSlot(final int slotIndex, final ItemStack proposedStack) {
        ...
        if (this.isSlotInRange(slotIndex)) {
            ...
            // Is this a view slot?
            if ((slotIndex >= PartArcaneCraftingTerminal.VIEW_SLOT_MIN)
                    && (slotIndex <= PartArcaneCraftingTerminal.VIEW_SLOT_MAX)) {
