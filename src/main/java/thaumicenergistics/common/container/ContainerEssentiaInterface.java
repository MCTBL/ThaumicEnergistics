...
public class ContainerEssentiaInterface extends ContainerUpgradeable implements IOptionalSlotHost {
    ...
    public ContainerEssentiaInterface(EntityPlayer player, World world, int x, int y, int z) {
    	this(player.inventory, (IInterfaceHost) world.getTileEntity(x, y, z));
	}
