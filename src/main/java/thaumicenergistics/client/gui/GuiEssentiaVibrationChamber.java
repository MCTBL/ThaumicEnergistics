...
public class GuiEssentiaVibrationChamber extends ThEBaseGui {
    ...
    private void drawTC_Textures() {
        ...
        this.drawTexturedModalRect(
                ...
                this.guiTop + GuiEssentiaVibrationChamber.STORED_POS_Y + storedHeightOffset,
                GuiEssentiaVibrationChamber.STORED_TEX_X,
                storedHeightOffset,
                GuiEssentiaVibrationChamber.STORED_WIDTH,
        ...
        this.drawTexturedModalRect(
                this.guiLeft + GuiEssentiaVibrationChamber.VIAL_POS_X,
                this.guiTop + GuiEssentiaVibrationChamber.VIAL_POS_Y,
                GuiEssentiaVibrationChamber.VIAL_TEX_X,
                0,
                GuiEssentiaVibrationChamber.VIAL_WIDTH,
        ...
        this.drawTexturedModalRect(
                ...
                this.guiTop + GuiEssentiaVibrationChamber.FIRE_POS_Y + progressHeightOffset,
                GuiEssentiaVibrationChamber.FIRE_TEX_X,
                progressHeightOffset,
                GuiEssentiaVibrationChamber.FIRE_WIDTH,
    ...
    public void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        if (ThEGuiHelper.INSTANCE.isPointInGuiRegion(
                GuiEssentiaVibrationChamber.VIAL_POS_Y,
                GuiEssentiaVibrationChamber.VIAL_POS_X,
                GuiEssentiaVibrationChamber.VIAL_HEIGHT,
                GuiEssentiaVibrationChamber.VIAL_WIDTH,
                mouseX,
                mouseY,
        ...
        // Is the mouse over the fire?
                ...
                GuiEssentiaVibrationChamber.FIRE_POS_Y,
                GuiEssentiaVibrationChamber.FIRE_POS_X,
                GuiEssentiaVibrationChamber.FIRE_HEIGHT,
                GuiEssentiaVibrationChamber.FIRE_WIDTH,
                mouseX,
                mouseY,
                this.guiLeft,
        ...
        // Is the mouse over the power bar?
                ...
                GuiEssentiaVibrationChamber.POWER_POS_X,
                GuiEssentiaVibrationChamber.POWER_HEIGHT,
                GuiEssentiaVibrationChamber.POWER_WIDTH,
                mouseX,
                mouseY,
                this.guiLeft,
