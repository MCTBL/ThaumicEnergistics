...
public interface IThEInteractionHelper {
     ...
     * power. Must be called from the server side.
     *
     * @param player
     */
    ...
    /**
     * The {@code IThEWirelessEssentiaTerminal} is assumed to be the item the player is holding, and is no longer needs
     * to be passed in.
     *
     *
     * @param player
     * @param terminalInterface is now ignored
